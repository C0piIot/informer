...
from accounts.forms.push_contact_form import TokensWidget, MultipleTokensField, fcm_token_validation
...
class PushContactFormTestCase(TestCase):
	...
	def testMultipleTokensField(self):
		multiple_tokens_field = MultipleTokensField(token_validation=fcm_token_validation)
